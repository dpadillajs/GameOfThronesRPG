...
function assignStage() {
    ...
    $( "[js-battleCard]" ).on( "click", function() {
        ...
        } else if (!blockFromChoosingDefender && 
...
function attackStage() {
    ...
    $attackButton.on( "click", function() {
        ...
        if ( defenderCard.hp <= 0 ) {
            ...
            $defResults.text( defenderCard.name + "'s army has been defeated. " + 
                              defenderCard.name + " died in combat." );
            ...
            if ( deadEnemies === 3 ) {
                ...
                $atkResults.text( ( totalAttackerDeadForces -= attackerCard.hp ) + 
                                    " of your men have died to break the wheel. " + 
                                    "The Iron Throne is yours." );
                $defResults.text( "Power resides where men believe it resides. " + 
        ...
        if ( attackerCard.hp > 0 && defenderCard.hp > 0 ) {
            ...
            if ( attackerCard.hp <= 0 ) {
                ...
                $atkResults.text( "When you play the game of thrones, you win or you die. " + 
                                  "There is no middle ground." );
                $defResults.text( defenderCard.name + " has wiped out your army. " + 
                ...
                $atkResults.text( "You have decreased " + defenderCard.name + 
                                  "'s forces by " + atkPower + "." );
                $defResults.text( defenderCard.name + " has decreased your forces by " + 
